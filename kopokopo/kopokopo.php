...
// public function initiatePayment($amount, $currency, $phoneNumber, $email, $firstName, $lastName, $orderId)
// {
//     $apiUrl = 'https://api.kopokopo.com/api/v1/incoming_payments';
//     $accessToken = $this->getAccessToken();
//     $tillNumber = Configuration::get('KOPOKOPO_TILL_NUMBER');
//     // $callbackUrl = $this->context->link->getModuleLink($this->name, 'callback', ['order_id' => $orderId], true);
//     $callbackUrl = $this->context->link->getModuleLink($this->name, 'callback', ['order_id' => $orderId], true);
...
//     // var_dump($httpCode,$responseArray);
//     // die;
